...
{
    public partial class mig_create_sender_receiver_and_messages_many_to_many_relation_table : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SenderReceiverPeople",
                columns: table => new
                {
                    SenderReceiverPersonID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SenderReceiverPeople", x => x.SenderReceiverPersonID);
                    table.ForeignKey(
                        name: "FK_SenderReceiverPeople_AspNetUsers_ReceiverID",
                        column: x => x.ReceiverID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SenderReceiverPeople_AspNetUsers_SenderID",
                        column: x => x.SenderID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SenderReceiverPeople_ReceiverID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SenderReceiverPeople_SenderID",
                table: "SenderReceiverPeople",
                column: "SenderID");
